cordova.define("org.bcsphere.bluetooth.bluetoothapi", function(require, exports, module) { 	/*
	...
	*/
	...
	var bluetooth = {
		...
		write : function(successFunc,errorFunc,deviceAddress,serviceIndex,writeValue){
			cordova.exec(successFunc,errorFunc, "BCBluetooth", "write", [{"deviceAddress":deviceAddress,"serviceIndex":serviceIndex,"writeValue":writeValue}]);
		},
